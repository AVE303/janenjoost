...
<div class="panel-display sutro-double clearfix <?php !empty($class) ? print $class : ''; ?>" <?php !empty($css_id) ? print "id=\"$css_id\"" : ''; ?>>
  ...
  <section class="section">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6 col-sm-6 sutro-double-column-content-region-1">
          <?php print $content['column1']; ?>
        </div>
        <div class="col-md-6 col-sm-6 sutro-double-column-content-region-2">
      ...
      <div class="row">
        <div class="col-md-6 col-sm-6 sutro-double-column-content-region-3">
          <?php print $content['secondcolumn1']; ?>
        </div>
        <div class="col-md-6 col-sm-6 sutro-double-column-content-region-4">
